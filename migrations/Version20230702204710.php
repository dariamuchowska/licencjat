 ...
 */
final class Version20230702204710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dogs (id INT AUTO_INCREMENT NOT NULL, breed_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, age INT NOT NULL, description VARCHAR(500) NOT NULL, photo_filename VARCHAR(255) DEFAULT NULL, INDEX IDX_353BEEB3A8B4A30F (breed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
